...
GLOBAL_DEFAULT_NON_BOLD_FONT = "5pt Noto Sans CJK SC"
GLOBAL_DEFAULT_BOLD_FONT = "bold 5pt Noto Sans CJK SC"
# GLOBAL_DEFAULT_BOLD_FONT = "bold 5pt Noto Serif Light CJK SC"
# GLOBAL_DEFAULT_NON_BOLD_FONT = "6pt Inconsolata"
# GLOBAL_DEFAULT_BOLD_FONT = "bold 6pt Inconsolata"

c.completion.height = "25%"

# c.fonts.monospace = "Inconsolata"
c.fonts.completion.category = GLOBAL_DEFAULT_BOLD_FONT
c.fonts.completion.entry    = GLOBAL_DEFAULT_NON_BOLD_FONT
c.fonts.statusbar           = GLOBAL_DEFAULT_NON_BOLD_FONT
c.fonts.debug_console       = GLOBAL_DEFAULT_NON_BOLD_FONT
c.fonts.downloads           = GLOBAL_DEFAULT_NON_BOLD_FONT
c.fonts.hints               = GLOBAL_DEFAULT_NON_BOLD_FONT
c.fonts.keyhint             = GLOBAL_DEFAULT_NON_BOLD_FONT
c.fonts.messages.error      = GLOBAL_DEFAULT_NON_BOLD_FONT
c.fonts.messages.info       = GLOBAL_DEFAULT_NON_BOLD_FONT
c.fonts.messages.warning    = GLOBAL_DEFAULT_NON_BOLD_FONT
c.fonts.statusbar           = GLOBAL_DEFAULT_NON_BOLD_FONT
c.fonts.tabs                = GLOBAL_DEFAULT_NON_BOLD_FONT
c.fonts.prompts             = GLOBAL_DEFAULT_NON_BOLD_FONT
...
c.bindings.commands['normal'] = {
    ...
    # '<ctrl-k>': 'fake-key <Del>',
    '<ctrl-k>': 'fake-key <Shift-End>;;fake-key <Del>',
